...
namespace Breifico.DataStructures
{
    ...
    public sealed class MyBinarySearchTree<T> : IEnumerable<T>, ICollection where T : IComparable<T>
    {
        ...
        /// <summary>
        /// Ищет минимальный элемент в коллекции. Если элемент отсутствует в коллекции 
        /// - функция вернет указанное значение, либо значение по умолчанию
        /// </summary>
        ...
        /// <summary>
        /// Ищет максимальный элемент в коллекции.  Если элемент отсутствует в коллекции 
        /// - функция вернет указанное значение, либо значение по умолчанию 
        /// </summary>
        /// <param name="def">Значение, которое вернет функция, если элемент в коллекции отсутствует</param>
